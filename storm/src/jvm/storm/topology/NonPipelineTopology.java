...
public class NonPipelineTopology extends TopologyParameters{
	...
	public static void main(String args[]) throws Exception {
		...
		NonPipelineBolt nonPipelineBolt = new NonPipelineBolt(nonPipelineBoltName, nonPiplelineBoltsName, nonPipelineInFields, nonPipelineOutFields, calibrationFileAddr,
		...
		builder.setBolt(nonPipelineBoltName, nonPipelineBolt, totalClusterNodeNum).shuffleGrouping(spoutName, spoutOutFields[0]);
